...
![alt text](/assets/img/general_research/1.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/2.PNG "image"){:.profile}<br>
...
<br>
![alt text](/assets/img/general_research/3.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/36.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/4.PNG "image"){:.profile}<br>
![alt text](/assets/img/general_research/5.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/48.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/43.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/44.PNG "image"){:.profile}<br>

Following table mentions MAC message types with its 3 bit "MType field": <br>
![alt text](/assets/img/general_research/45.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/46.PNG "image"){:.profile}<br>
...
![alt text](/assets/img/general_research/47.PNG "image"){:.profile}<br>
