...
description: "&nbsp;&nbsp;&nbsp;&nbsp;In digital signal processing, a digital down-converter (DDC) converts a digitized, band-limited signal to a lower frequency signal at a lower sampling rate..."
tags: [Research@Agency]
---

![alt text](assets/img/general_research/9.PNG "image"){:.profile}<br>
...
![alt text](assets/img/general_research/10.PNG "image"){:.profile}<br>
...
![alt text](assets/img/general_research/11.PNG "image"){:.profile}<br>
...
![alt text](assets/img/general_research/16.PNG "image"){:.profile}<br>
![alt text](assets/img/general_research/17.PNG "image"){:.profile}
