...
![alt text](/assets/img/mosfet/e1.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e2.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/e3.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e5.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;First, cut the thick oxide layer through etching.
![alt text](/assets/img/mosfet/e6.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Then, cover the titanium layer with low contact resistance.
![alt text](/assets/img/mosfet/e7.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;TiN acts as a barrier, preventing the metal to be pluggable from diffusing into oxide.
![alt text](/assets/img/mosfet/e8.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/e2d.gif "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;If this process is represented by 3D structure, it will be as follows.
![alt text](/assets/img/mosfet/e3d.gif "image"){:.profile}


<br>
![alt text](/assets/img/mosfet/e11.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Since we installed the plug, let's find out about the interconnection line that will connect these plugs organically.
<br>
![alt text](/assets/img/mosfet/e12.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e13.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e14.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e15.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e16.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e17.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e18.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e19.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e20.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e22.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/e23.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/e24.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/e25.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/e26.jpg "image"){:.profile}
