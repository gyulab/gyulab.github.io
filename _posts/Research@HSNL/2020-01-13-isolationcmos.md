...
![alt text](assets/img/mosfet/i1.jpg "image"){:.profile}
...
<br>
![alt text](assets/img/mosfet/i2.jpg "image"){:.profile}
![alt text](assets/img/mosfet/i3.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i4.jpg "image"){:.profile}
...
<br>
![alt text](assets/img/mosfet/i5.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i6.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i7.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i8.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i9.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Let's find out more about the LOCOS process introduced earlier.
![alt text](assets/img/mosfet/i11.jpg "image"){:.profile}
![alt text](assets/img/mosfet/i10.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i12.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i13.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;To solve this Bird's Bake phenomenon, various techniques such as SWAMI, SPOT, OSELO, and FUROX were utilised.



![alt text](assets/img/mosfet/i14.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Now let's learn about Trench Isolation.


![alt text](assets/img/mosfet/i15.jpg "image"){:.profile}
...
<br>
![alt text](assets/img/mosfet/i16.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;STI(Shallow Trench Isolation) Process

![alt text](assets/img/mosfet/i17.jpg "image"){:.profile}
...
![alt text](assets/img/mosfet/i18.jpg "image"){:.profile}
...
<br>
![alt text](assets/img/mosfet/i19.jpg "image"){:.profile}
