...
![alt text](/assets/img/mosfet/x1.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x2.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x3.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x4.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x5.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Let's look at the basic BSIM model (BSIM1).
![alt text](/assets/img/mosfet/x6.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x7.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x8.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x9.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x10.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x11.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x12.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x13.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Let's find out about the BSIM-BULK model.
<br>

![alt text](/assets/img/mosfet/x14.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x15.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x16.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x17.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Let's find out about the BSIM-SOI model
<br>

![alt text](/assets/img/mosfet/x18.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/x19.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x20.jpg "image"){:.profile}
...
![alt text](/assets/img/mosfet/x21.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Let's look at the BSIM-IMG model.
<br>

![alt text](/assets/img/mosfet/x22.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/x23.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/x24.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x25.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;This is an example of I-V and C-V curves of BSIM-BULK.

<br>
![alt text](/assets/img/mosfet/x26.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;Finally, let's look at the BSIM-CMG model.
<br>

![alt text](/assets/img/mosfet/x27.jpg "image"){:.profile}
...
<br>
![alt text](/assets/img/mosfet/x28.jpg "image"){:.profile}
![alt text](/assets/img/mosfet/x29.jpg "image"){:.profile}
&nbsp;&nbsp;&nbsp;&nbsp;This is an example of I-V and C-V curves of BSIM-CMG.



<br>
![alt text](/assets/img/mosfet/x30.jpg "image"){:.profile}
