...
thumbnail: /assets/img/research/pino_architecture.png
tags: [1_Georgia_Tech]
---

**Preprint**: <a href="https://arxiv.org/abs/2603.06881" target="_blank">ArXiv Link: https://arxiv.org/abs/2603.06881</a><br><br>
This work is presented at ICMC (International Compact Modeling Conference) 2026!
![icmc-conference](/assets/img/icmc-presenting.jpg "image"){:.profile}<br>

# Motivation: TCAD Bottleneck for fast DSE
...
#### Architecture
![PINO Architecture](/assets/img/research/pino_architecture.png "image"){:.profile}<br>
...
![AOS String Result](/assets/img/research/planar-comparison.png "image"){:.profile}<br>
<img src="/assets/img/research/temperature_sweep_reconstructed.gif" alt="AOS String Result" style="width: 100%; max-width: 600px; display: block; margin: 0 auto;">
<img src="/assets/img/research/gate_charge_temperature.gif" alt="AOS String Result" style="width: 100%; max-width: 600px; display: block; margin: 0 auto;">
...
![AOS String Result](/assets/img/research/design-space-exploration.png "image"){:.profile}<br>
...
![AOS String Result](/assets/img/research/aos_result.png "image"){:.profile}<br>
![AOS String Result](/assets/img/research/trapped-charge.png "image"){:.profile}<br>
