...
tags: 1_Georgia_Tech
---
<b><p>This project is ongoing, so stay tuned for updates!</p></b><br>
...
![AOS String Result]({{ site.baseurl }}/assets/images/research/temperature_sweep_reconstructed.gif "image"){:.profile}<br>
![AOS String Result]({{ site.baseurl }}/assets/images/research/gate_charge_temperature.gif "image"){:.profile}<br>
