...
description: "&nbsp;&nbsp;&nbsp;&nbsp;앞서 보았던 Basic concepts of MOSFET에 이어서, 오늘은 Body Bias Effect 외 5가지의 Additional한 Effect에 대하여 알아보도록 하자. &nbsp;&nbsp;&nbsp;&nbsp; Substrate Bias Effect란 Body Bi..."
tags: [Academics]
---

![alt text](/assets/img/mosfet/m7.PNG "Profile Picture"){:.profile}

&nbsp;&nbsp;&nbsp;&nbsp;앞서 보았던 Basic concepts of MOSFET에 이어서, 오늘은 Body Bias Effect 외 5가지의 Additional한 Effect에 대하여 알아보도록 하자.
<br>

![alt text](/assets/img/mosfet/m8.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m9.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m10.PNG "Profile Picture"){:.profile}
<br>
...
![alt text](/assets/img/mosfet/m11.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m12.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m13.PNG "Profile Picture"){:.profile}
