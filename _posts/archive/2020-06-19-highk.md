...
description: "&nbsp;&nbsp;&nbsp;&nbsp;Modern CMOS의 performance 향상은 주로 물리적인 scaling을 통해서 발전하였다. Device의 크기를 반도체 공정 기술의 발전을 보여주는 Moore’s Law와 같이 줄여 가면서, gate와 채널 사이에 있는 dielectric 의 scaling 문제가 불..."
tags: [Academics]
---
...
<br>
![alt text](/assets/img/gyulab/ru1.PNG "image"){:.profile}
<br>
...
<br>
![alt text](/assets/img/gyulab/ru2.PNG "image"){:.profile}
<br>
...
<br>
![alt text](/assets/img/gyulab/ru3.PNG "image"){:.profile}
<br>
...
1)	Silicon Nitroxide
<br>
![alt text](/assets/img/gyulab/ru4.PNG "image"){:.profile}
<br>
...
<br>
![alt text](/assets/img/gyulab/ru5.PNG "image"){:.profile}
<br>
