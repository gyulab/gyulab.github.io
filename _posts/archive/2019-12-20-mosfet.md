...
description: "&nbsp;&nbsp;&nbsp;&nbsp;Let's learn about MOSFET, which is the most important element that we learned in the Semiconductor Devices course and is also the most used element. &nbsp;..."
tags: [Research@HSNL]
---
...
<br>
![alt text](/assets/img/mosfet/m1.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m2.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m3.PNG "Profile Picture"){:.profile}
<br>
...
![alt text](/assets/img/mosfet/m4.PNG "Profile Picture"){:.profile}
...
![alt text](/assets/img/mosfet/m5.PNG "Profile Picture"){:.profile}
